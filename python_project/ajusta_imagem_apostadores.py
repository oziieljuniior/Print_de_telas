...
while i <= 10:
    ...
    name_path = "/home/oziel/Documentos/Personal_project/Aviator/Print_de_telas/data3/qt_apostadores/" + name
    image = cv2.imread(name_path)
    gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
    kernel = np.ones((1,1),np.float32)/3
...
#     indice_ex += 1
#     i += 1
# # #C:\\Users\\Riallen\\Documents\\Print_de_telas\\
# name = '/home/oziel/Documentos/Personal_project/Aviator/Print_de_telas/qt_apostadores1.xlsx'  
# wb.save(name)
# # #     
# # =============================================================================
# # =============================================================================
